...
public class DragGestureView  extends FrameLayout implements IGestureComponent {

    public DragGestureView(@NonNull Context context) {
        super(context);
    }

    public DragGestureView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public DragGestureView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.drag_control_view, this, true);
